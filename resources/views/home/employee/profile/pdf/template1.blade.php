...
<head>
    ...
    <!-- Load font awesome -->
    <base href="{{ asset('/') }}" />
	<link rel="stylesheet" href="manage/vendor/font-awesome-4.7/css/font-awesome.min.css">
...
<body style="width: 793px; background-color: #ffdada">
	<div class="wrapper flex">
		<div class="sidebar float-left">
			<div class="avatar">
                <img src="img/profiles/102.jpg" width="215" height="215" alt="Md Alamin Mir" />
				<h1 class="name">Employee Namee</h1>
				<h4 class="job">Ngành Nghề</h4>
			</div><!-- .avatar -->

			<div class="module">
				<h3 class="module__title">
					<i class="fa fa-user circle circle--medium"></i>
					<span>@lang('profile_home.career_goals')</span>
				</h3>
